...
<div bind:this={el}>
	<Content>
		...
		<p>
			...
			, a
			<a href="https://felt.social">community and business</a>
			, a
			<a href="https://twitter.com/feltcoop">co-op of worker-owners</a>
			, and hopefully one day a
			<a href="https://platform.coop/">platform co-op</a>
			(communities owning themselves? absurd) — all with a purpose that puts
			people first. If we do it right, Felt is tech that feels good.
		</p>
		<p>
			...
			a person so we will treat you like one. We hope to provide an amazing
			customer experience, but you can always export your data from our service
			to another.
		</p>
		<p>
			...
			The Business remain accountable to its users, workers, and society. In the
			future, we want to explore the
