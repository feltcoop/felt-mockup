...
<div class="p-2" bind:this={el}>
	<Content>
		...
		<p>
			Felt is a set of tools for building customizable self-governing
			communities. It seeks to empower us, help us organize, and improve our
			communication. It's a free and open source alternative to many websites
			and apps tucked into a warm fuzzy package.
		</p>
		<p>
			Our team is small and our goals are over the top. Through the might of
			software we aim to help people solve priority problems with
		...
		<p>
			...
			>, a <a href="https://felt.social">community and business</a>, a
			<a href="https://twitter.com/feltcoop">co-op of worker-owners</a>, and
			hopefully one day a
			<a href="https://platform.coop/">platform co-op</a>
			(communities owning themselves? absurd) — all with a purpose that puts people
			first. If we do it right, Felt is tech that feels good.
		</p>
		<p>
			Felt The Business makes money (or will!) by selling value to users. Mostly
			this is through subscription services and commerce mediation like
			<a href="https://felt.social">Felt.social</a>. We want a business model
			that keeps our incentives aligned with our users, so we accept no revenue
			from third parties like advertisers. You're a person so we will treat you
			like one. We hope to provide an amazing customer experience, but you can
			always export your data from our service to another.
		</p>
		<p>
			The company behind Felt is a democratic worker co-op where us workers
			share equal ownership and control. We believe this model will help Felt
			The Business remain
			<span class="font-bold whitespace-no-wrap">→ accountable ←</span>
			to its users, workers, and society. To learn more about why we chose this business
			structure, see our (forthcoming) blog post "Why Felt is a worker co-op". In
			the future, we want to explore the
		...
		<p>
			...
			<span class="font-bold">
				...
				expect security when you run this software. Assume everything is broken or
				fake.
			</span>
		</p>
		<p>
			...
			>, so you can run a private instance for your communities and maintain
			full control.
		</p>
