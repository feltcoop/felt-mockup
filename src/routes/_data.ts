...
interface PeopleData extends Entity {
	type: 'person';
	name: string;
	avatars: AvatarData[];
}
...
const data: Data = {
	...
	worlds: [
		...
		// communities
		{
			...
			title: 'felt',
			slug: 'felt',
			description: '<small>meta discussion about the felt community</small>',
			spaces: [
				...
				{ type: 'chat', id: id(), title: 'random', slug: 'random', messages },
		...
		},
		{
			...
			slug: 'village',
			description:
				'<small>a carefully curated community for people who care</small>',
			spaces: [
					...
					topics: [
						{
							...
							id: id(),
							author: 'ryan',
							title: 'commerce in the bazaar is prohibited!1!',
